...
int main()
{
    ...
    for (int i = 0; i < num_tests; i++)
    {
        ...
        MDPModel model(conf.get_model_conf(), false);
        ...
        for (int time = 0; time < training_steps + eval_steps; time++)
        {
            ...
            else
            {
                ...
                cout << "ACTION SUGGESTED: " << action.first << " , " << action.second << endl;
            }
            /*UNCOMMENT TO MONITOR VALUE CHANGE OF EVERY STATE THROUGHOUT THE EXECUTION
            ...
            if (time > training_steps)
            {
                ...
                //cout << "Current Capacity: " << scenario.get_current_capacity() << endl;
            }
